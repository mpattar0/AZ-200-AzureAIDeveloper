...
Personal hands-on learning workspace for the AI-200 exam, organized into **10 topic areas and 27 labs**: 26 service-focused exercises plus one supplementary AI foundation lab.
...
1. Start with [AI foundations: models, prompts, and grounding](labs/00-ai-foundations/01-models-prompts-and-grounding/README.md), then use the official resources above for the service-focused exercises.
...
The AI foundation lab contains instructions, checkpoints, and space for notes. The existing service-focused lab folders are scaffolds; their per-lab documentation has not yet been added, so the corresponding checklist links are placeholders. Add code and other files as you work through each lab; do not commit credentials, connection strings, or other secrets.

```text
labs/
├── 00-ai-foundations/
│   └── 01-models-prompts-and-grounding/
...
### 00. AI foundations (supplementary)

- [ ] [Explore models, prompts, and grounding in Microsoft Foundry](labs/00-ai-foundations/01-models-prompts-and-grounding/README.md)
...
The 26 service-focused exercises were checked against Microsoft's lab index on **2026-09-09**. The supplementary AI foundation lab was added on **2026-09-11** and is not an official Microsoft exercise. Exercises may change; use the official course and study guide to confirm current exam coverage.
